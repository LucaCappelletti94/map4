...
findID3 = pickle.load(open(data_path + "metabolome_compact.mhap4-512_dictionary", "rb"))

lf4.restore(data_path + "chembl_25_wAct_comp.mhfp6_LSHforest")
findID4 = pickle.load(open(data_path + "chembl_25_wAct_comp.mhfp6_dictionary", "rb"))
...
def index():
    ...
    return render_template(
        "index.html", DB=["ChEMBL", "Metabolome", "SwissProt"], FP=["MAP4", "MHFP6"]
    )
...
def results():
    ...
    results = similarity_search(db, mol, hits, lf1, lf2, lf3, findID1, findID2, findID3)
